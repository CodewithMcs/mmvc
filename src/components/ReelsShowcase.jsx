      ...
      {reels.map((item) => (
        ...
        >
          ...
          <div className="reel-info">
            <span className={`reel-badge ${item.badge === 'Reels' ? 'reel-badge--ig' : 'reel-badge--yt'}`}>
              {platformIcon(item.badge)}
              {item.badge}
            </span>
            <h3 className="reel-title">{item.title}</h3>
            <span className="reel-platform-label">{item.platform}</span>
          </div>
        </a>
      ))}
    </div>
